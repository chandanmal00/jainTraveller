                    ...
                    <div class="grey" style="float:left;width:350px;">
                        <div id="photo" class="tileset">
                            <#if userProfile?? && userProfile["profilephoto"]??>
                                 ...
                                 <img src="/images/thumbnail.${userProfile["profilephoto"]}" alt="${userProfile["profilephoto"]}" class="builtBy">
                            <#else>
                                 <p style="text-align:center;"> update your latest avatar</p>
                                 <img src="/images/thumbnail.${defaultPhoto}" alt="${defaultPhoto}" class="builtBy">
                            </#if>
                        </div>
