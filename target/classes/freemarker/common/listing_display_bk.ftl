...
<#function showJainConfirmed post>
    ...
    <#return false>
        ...
        <div class="row">
        <div class="col-md-4" id="title_${cnt}">Type: ${post["type"]!""} : <a href="/post/${post["permalink"]}">${post["name"]}</a></div>
        <div class="col-md-4">
        ...
        <div class="row">
                ...
                <div class="class-md-4">col1
                </div>
                <div class="class-md-4">col2
                                </div>
        </div>
                        ...
                        <div class="carousel" style="visibility: visible; overflow: hidden; position: relative; z-index: 2; left: 0px; width: 400px;">
                            <ul style="margin: 0px; padding: 0px; position: relative; list-style: outside none none; z-index: 1; width: 1760px;left:0px;">
                                 <#list post["userImages"] as tag>
                                     <li style=" border-color: #ccc; border-style: solid; border: 1px, padding:2px;overflow: hidden; float: left; width: ${WIDTH}px; height: ${HEIGHT}px;"><img src="/images/${post["permalink"]}/thumbnail.${tag["imageName"]}" class="img-circle" alt="Image"></li>
                                 </#list>
                           </ul>
                        </div>
